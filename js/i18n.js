const TRANSLATIONS = {
  en: {
    ...
    studentProfile: {
      ...
      editAppModalTitle: 'Edit Your Application', editAppEmail: 'Email Address', editAppPhone: 'Phone Number', editAppCoverLetter: 'Cover Letter / Why should we hire you?', editAppSave: 'Save Changes', editAppProfileNote: 'To update contact details, edit your profile.',
      ...
      deleteModalDesc: 'This will permanently remove all your data from the platform in accordance with GDPR Art. 17. The following will be deleted:',
      ...
      btnConfirmDelete: 'Delete account',
    ...
    pages: {
      ...
      support: {
        ...
        c5H: '👤 Account Help', c5P: 'Problems with login, registration, or profile? We can help you fix it.', c5Btn: 'Contact Us',
    ...
    studentProfile: {
      ...
      editAppModalTitle: 'Muokkaa hakemustasi', editAppEmail: 'Sähköpostiosoite', editAppPhone: 'Puhelinnumero', editAppCoverLetter: 'Saatekirje / Miksi meidän pitäisi palkata sinut?', editAppSave: 'Tallenna muutokset', editAppProfileNote: 'Päivitä yhteystiedot muokkaamalla profiiliasi.',
      ...
      deleteModalTitle: 'Poistetaanko tilisi?',
      deleteModalDesc: 'Tämä poistaa pysyvästi kaikki tietosi alustalta GDPR:n 17. artiklan mukaisesti. Seuraavat tiedot poistetaan:',
      ...
      deleteConfirmPrompt: 'Vahvistaaksesi kirjoita',
      btnConfirmDelete: 'Poista tili',
    ...
    pages: {
      ...
      support: {
        ...
        c5H: '👤 Tiliapua', c5P: 'Ongelmia kirjautumisen, rekisteröinnin tai profiilin kanssa? Voimme auttaa sinua ratkaisemaan ne.' , c5Btn: 'Ota yhteyttä',
  ...
  sv: {
    ...
    studentProfile: {
      ...
      editAppModalTitle: 'Redigera din ansökan', editAppEmail: 'E-postadress', editAppPhone: 'Telefonnummer', editAppCoverLetter: 'Personligt brev / Varför ska vi anställa dig?', editAppSave: 'Spara ändringar', editAppProfileNote: 'För att uppdatera kontaktuppgifter, redigera din profil.',
      ...
      deleteModalTitle: 'Ta bort ditt konto?',
      deleteModalDesc: 'Detta tar permanent bort alla dina uppgifter från plattformen i enlighet med GDPR Art. 17. Följande kommer att raderas:',
      ...
      deleteConfirmPrompt: 'Bekräfta genom att skriva',
      btnConfirmDelete: 'Ta bort konto',
    ...
    pages: {
      ...
      support: {
        ...
        c5H: '👤 Kontohjälp', c5P: 'Problem med inloggning, registrering eller profil? Vi kan hjälpa dig lösa det.' , c5Btn: 'Kontakta oss',
